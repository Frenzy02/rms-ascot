        ...
        <section className="features scroll-animation">
            ...
            <div className="features-container">
                <div className="feature scroll-animation">
                    ...
                    <p>
                        We offer thorough medical check-ups to ensure your
                ...
                <div className="feature scroll-animation">
                    ...
                    <p>
                        Our specialists provide detailed consultations to
                        address all your health concerns.
                    </p>
                </div>
                <div className="feature scroll-animation">
                    ...
                    <p>
                        We create customized treatment plans tailored to your
                        individual needs.
                    </p>
                </div>
            </div>
