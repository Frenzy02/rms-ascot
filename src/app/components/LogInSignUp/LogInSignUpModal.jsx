...
export default function LogInSignUpModal({ onClose }) {
            ...
            if (user) {
                ...
                if (userData) {
                    if (userData.role === 'admin') {
                        ...
                        // Optionally handle cases for unknown roles or redirect to a default page
                        router.push('/') // Replace with your default route if needed
                    }
                }
            }
        })
    ...
    const handleLogin = async (e) => {
        ...
        console.log('Logging in with:', formData.email) // Log the email being used for login

        const response = await signInUser(formData.email, formData.password)

        console.log('Login Response:', response) // Log the response from the signInUser function
        ...
        if (response.success) {
            ...
            // Redirect based on user role
            const userRole = response.user.role // Get user role directly from response
